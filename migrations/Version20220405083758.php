 ...
 */
final class Version20220405083758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stade (id INT AUTO_INCREMENT NOT NULL, stade VARCHAR(255) NOT NULL, alt INT NOT NULL, lng INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
