...
class EquipeController extends AbstractController
{
     ...
     */
    public  function FormationEquipeBack(Request $request,EquipeRepository $equipeRepository,FormationRepository $joueurRepository,$id)
    {
        $email = $request->getSession()->get('_security.last_username');
        if($email == null){
            return $this->redirectToRoute('app_login');
  ...
  public  function stadeEquipe(EquipeRepository $equipeRepository,StadeRepository $StadeRepository,$id)
     ...
     */
    function ListJoueurByEquipeback(Request $request,EquipeRepository $equipeRepository,JoueurRepository $joueurRepository,$id)
    {
        $email = $request->getSession()->get('_security.last_username');
        if($email == null){
            return $this->redirectToRoute('app_login');
