...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/client/", name="app_user_home", methods={"GET"})
     */
    ...
    /**
     * @Route("/admin/ban/{id}", name="app_user_ban", methods={"GET","POST"})
     */
    public function ban(Request $request, User $user, UserRepository $userRepository,$id): Response
    {
